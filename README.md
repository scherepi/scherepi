Hi, I'm Guac! I'm a young cybersecurity student, developer, and microcelebrity ([guaclovesyou](https://instagram.com/guaclovesyou)) [Hack Club](https://hackclub.com) [Gap Year Fellow](https://manifesto.hackclub.com). I'm interested in a lot of different technologies and techniques, from Linux (Kali, Arch, and Raspbian) to Java (ITS certified btw) to hardware hacking. You can find my personal website at [jschere.com](https://jschere.com), and my blog at [guacloves.you](https://guacloves.you).

Here are some projects I'm extra proud of:
- [Conduit](https://github.com/scherepi/conduit), an awesome local tunnel system built in Bun and TypeScript that uses subdomains to make sharing your projects a breeze. Built for [Shipwrecked](https://shipwrecked.hackclub.com) with my friends [Gus](https://github.com/gusruben) and [Sebastian](https://github.com/XDagging). <i>NOW FEATURING END-TO-END ENCRYPTION!</i>
- [Troubadour](https://troubadour-blue.vercel.app), a personal lyrical analysis database built because I hate Genius. Now, you can keep all your thoughtful annotations for California Gurls in one organized place.
